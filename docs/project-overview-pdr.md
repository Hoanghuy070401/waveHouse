...
> **Phiên bản:** 1.0.0 | **Cập nhật:** 2026-04-17 | **Nền tảng:** Android (Kotlin)
...
- [x] Danh sách sản phẩm (phân trang, tìm kiếm, lọc)
...
### 3.3 Quản Lý Kho
- [x] Xem tồn kho theo vị trí kho (Location)
- [x] Nhập kho (Purchase Order)
- [x] Xuất kho (Sales Order / Transfer)
- [ ] Điều chỉnh tồn kho (Inventory Adjustment)
- [x] Cảnh báo tồn kho dưới ngưỡng (Low Stock Alert)
- [ ] Chuyển kho (Stock Transfer)
- [x] Bán hàng nhanh (POS screen)
